...
import random
import argparse
from register_music_blueprint import register_music_blueprint
...
def main():
    parser = argparse.ArgumentParser(description='Setup and run Chad Battles')
    parser.add_argument('--env', choices=['development', 'testing', 'production'], 
                      default='development', help='Environment to run the application in')
    args = parser.parse_args()
    
    # First, register the music blueprint
    print("Registering music player blueprint...")
    register_music_blueprint()
    
    # Set the environment
    os.environ['FLASK_ENV'] = args.env
    
    # Continue with normal setup and run
    print(f"""
===============================================================================
                CHAD BATTLES - SETUP AND RUN ({args.env.upper()})
===============================================================================
""")
